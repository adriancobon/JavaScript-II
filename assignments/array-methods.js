...
console.log(allCaps); 	console.log(allCaps); 
...
console.log(largeShirts);	console.log(largeShirts);
...
for (let i = 0; i < runners.length; i++) {
 ...
 let ticketPriceTotal = [];	let ticketPriceTotal = [];
...
runners.forEach(function(companyAmount) {
 ...
 // Problem 3 	console.log(companyDonation)
// Problem 3
